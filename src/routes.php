...
Route::group(['middleware' => ['auth.pulsar','permission.pulsar','locale.pulsar']], function() {
    ...
    */
    ...
    Route::get(config('pulsar.appName') . '/forms/comments/{ref}/{id}/show/{offset}',                               ['as'=>'showFormsComment',                'uses'=>'Syscover\Forms\Controllers\Comments@showRecord',                      'resource' => 'forms-comment',        'action' => 'access']);
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    Route::any(config('pulsar.appName') . '/forms/preferences',                             ['as'=>'FormsPreference',               'uses'=>'Syscover\Forms\Controllers\Preferences@index',             'resource' => 'forms-preference',     'action' => 'access']);
    Route::put(config('pulsar.appName') . '/forms/preferences/update',                      ['as'=>'updateFormsPreference',         'uses'=>'Syscover\Forms\Controllers\Preferences@updateRecord',      'resource' => 'forms-preference',     'action' => 'edit']);
});